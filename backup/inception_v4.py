...
from tensorflow.keras.layers import MaxPooling2D, Concatenate, AveragePooling2D, Dropout, GlobalAveragePooling2D, Dense, Input
...
def Inception_v4(input_shape, classes=1000):
    ...
    x = Stem(Input(input_shape), version=version, name='Stem') # (299, 299, 3) -> (35, 35, 384)
